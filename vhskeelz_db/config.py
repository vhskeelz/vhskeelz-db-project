...
PROCESSING_RECORD_CONTEXT_IGNORE_EXCEPTIONS_IF_RECENT_SUCCESS = os.environ.get('PROCESSING_RECORD_CONTEXT_IGNORE_EXCEPTIONS_IF_RECENT_SUCCESS') == 'true'
PROCESSING_RECORD_CONTEXT_IGNORE_EXCEPTIONS_IF_RECENT_SUCCESS_INTERVAL = os.environ.get('PROCESSING_RECORD_CONTEXT_IGNORE_EXCEPTIONS_IF_RECENT_SUCCESS_INTERVAL') or '2 day'
...
SALESFORCE_CANDIDATES_ACCOUNT_ID = os.environ.get('SALESFORCE_CANDIDATES_ACCOUNT_ID')
SALESFORCE_CASE_RECORD_TYPE_ID = os.environ.get('SALESFORCE_CASE_RECORD_TYPE_ID')
SALESFORCE_CANDIDATES_CASE_RECORD_TYPE_ID = os.environ.get('SALESFORCE_CANDIDATES_CASE_RECORD_TYPE_ID')
